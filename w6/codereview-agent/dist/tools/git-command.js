...
exports.gitCommandTool = {
    name: "git_command",
    description: "Execute read-only git commands to get code changes, history, and repository information. Supports: diff, show, log, status, branch, etc. Dangerous commands (reset, checkout, push, etc.) are blocked.",
    parameters: {
        type: "object",
        properties: {
            args: {
                type: "array",
                items: { type: "string" },
                description: "Arguments to pass to git command. Examples: ['diff'], ['show', 'abc123'], ['diff', 'main...HEAD']",
            },
        },
        required: ["args"],
    },
